  ...
  return (
    <div className="login-page">
      ...
      <div style={{
        ...
        background: 'radial-gradient(ellipse at 30% 30%, rgba(192,131,90,0.06) 0%, transparent 60%), radial-gradient(ellipse at 70% 70%, rgba(80,144,216,0.04) 0%, transparent 60%)',
        pointerEvents: 'none',
      }} />

      <form className="login-card" onSubmit={handleLogin} style={{ position: 'relative', zIndex: 1 }}>
        {/* Logo */}
